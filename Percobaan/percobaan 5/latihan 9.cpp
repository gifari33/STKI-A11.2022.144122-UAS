...
int main() {
    ...
    std::string outputPath = R"(J:\Drive Saya\analisa sentimen git\percobaan 5\tokenized_train_data.csv)";
    ...
    while (std::getline(inputFile, line)) {
        ...
        outputFile << fullText << "," << value << "," << tokenizedText << "\n";
    }
